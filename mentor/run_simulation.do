set QSYS_SIMDIR /data/firmware/quartus/extrapolator
source $QSYS_SIMDIR/mentor/msim_setup.tcl
dev_com
com
vcom -work work $QSYS_SIMDIR/Extrapolator_tb.vhd
vcom -work work $QSYS_SIMDIR/Extrapolator_Package.vhd
vcom -work work $QSYS_SIMDIR/Extrapolator_Main.vhd
vcom -work work $QSYS_SIMDIR/Extrapolator_Decoder.vhd
vcom -work work $QSYS_SIMDIR/Extrapolator_Constants_Loader.vhd
...
#     fifo_8LSector.fifo_8LSector
#     fifo_13LSector.fifo_13LSector
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/home/markus/intelFPGA_pro/19.3/quartus/"
}
...
alias dev_com {
  ...
  if [string is false -strict [modelsim_ae_select $FORCE_MODELSIM_AE_SELECTION]] {
    ...
    eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctp_hssi_components.vhd"              -work fourteennm_ct1    
    eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctp_hssi_atoms.vhd"                   -work fourteennm_ct1    
  }
}
